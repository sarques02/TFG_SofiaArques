...
mse_loss = torch.nn.L1Loss()  # Changed to L1 Loss
...
for epoch in range(num_epochs):
    ...
    print_log(epoch + 1, num_epochs, one_epoch_time, date, avg_val_loss, loss)
    torch.save(student.state_dict(), f"{save_folder_path}/student_epoch_{epoch+1}.pth")
    
    if best_loss is None or avg_val_loss < best_loss - min_delta:
        ...
        if epochs_no_improve >= patience:
            ...
            break
torch.save(student.state_dict(), f"{save_folder_path}/student_final.pth")
